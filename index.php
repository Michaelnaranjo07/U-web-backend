...
<head>
  ...
  <title>ABOGADOS UCOMPENSAR - <?php include('dist/includes/title.php');?></title>
    ...
    <title>ABOGADOS UCOMPENSAR</title>
    <!-- meta tags -->
    <meta charset="UTF-8" />
...
<body>
    <center>
    <h2 style="color:white;">https://www.facebook.com/profile.php?id=100083048326773</h2>
    </center>
    <div class=" w3l-login-form">
        <h2>ABOGADOS UCOMPENSAR</h2>
    <form action="login.php" method="post">
            ...
            <div class="forgot">
                <a href="https://www.facebook.com/profile.php?id=100083048326773">FanPage</a>
                <p><input type="checkbox">Recordar password</p>
            </div>
            <button type="submit" name="login">INICIAR SESION</button>
        </form>
        <p class=" w3l-register-p">Cotiza tu desarrollo web por chat aqui?<a href="https://www.facebook.com/CompaniaTecnoPc" class="register" target="_blank"> aqui</a></p>
    </div>
    <footer>
